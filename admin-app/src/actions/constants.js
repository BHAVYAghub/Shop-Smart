...
export const customerLoginConstants = {
...
export const customerFetchContants = {
  CUSTOMER_FETCH_REQUEST: "CUSTOMER_FETCH_REQUEST",
  CUSTOMER_FETCH_SUCCESS: "CUSTOMER_FETCH_SUCCESS",
  CUSTOMER_FETCH_FAILURE: "CUSTOMER_FETCH_FAILURE",
};

export const customerResetContants = {
  CUSTOMER_RESET_PASSWORD_REQUEST: "CUSTOMER_RESET_PASSWORD_REQUEST",
  CUSTOMER_RESET_PASSWORD_SUCCESS: "CUSTOMER_RESET_PASSWORD_SUCCESS",
  CUSTOMER_RESET_PASSWORD_FAILURE: "CUSTOMER_RESET_PASSWORD_FAILURE",
  CUSTOMER_RESET_PASSWORD_REINITIALISE: "CUSTOMER_RESET_PASSWORD_REINITIALISE",
};
